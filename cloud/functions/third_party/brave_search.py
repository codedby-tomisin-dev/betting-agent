...
class BraveSearch(BaseThirdParty):
    ...
    def search(
        ...
        country: str = "us",
        search_lang: str = "en",
        freshness: Literal['pw', 'pm'] = 'pw',
        safe_search: Optional[str] = None,
        extra_params: Optional[Dict[str, str]] = None,
        content_types: List[Literal['discussions', 'infobox', 'news', 'videos']] = ['discussions', 'infobox', 'news'],
    ) -> List[CrawledContent]:
        """
    ...
    def search_news(
        ...
        logger.info(f"Brave News Search Parameters: {params}")
